# Coursera-Exploratory-Data-Analysis-with-R-W4
...
For each plot you should
    ...
    Copy and paste the R code from the corresponding R file into the text box at the appropriate point in the peer assessment._"
